...
// Configuración de la base de datos - AJUSTA LA CONTRASEÑA AQUÍ
const dbConfig = {
  host: 'localhost',
  port: 3306,
  user: 'root',
  password: 'root', // Contraseña configurada
...
app.post('/api/usuarios', async (req, res) => {
  ...
  try {
    ...
    // Validación básica
    if (!primer_nombre || !primer_apellido || !nombre_usuario || !correo_electronico || !contraseña) {
